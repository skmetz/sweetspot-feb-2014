...
class BeerVerse
  ...
  def to_s
    ...
    "#{bottle_number} of #{liquid} #{location}, ".capitalize +
    "#{bottle_number} of #{liquid}.\n" +
    "#{bottle_number.action}, " +
    "#{bottle_number.next} of #{liquid} #{location}.\n"
  end
...
# Add to_s to BottleNumber to deal with data clump
